...
# Distro-sync - Ensures that system is in a reliable state matching the exact versions of
# packages meant for that version of the distro, abiding more by SSoT.
# 
# Updating - Some pkgs upgrade, others may break
# 
...
# Distro-sync fixes package conflicts and missing dependencies
